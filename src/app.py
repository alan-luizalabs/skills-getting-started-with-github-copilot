...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 16,
        "participants": ["noah@mergington.edu", "madison@mergington.edu"]
    },
    "Swimming Squad": {
        "description": "Swim training and conditioning for races and water fitness",
    ...
    "Science Olympiad": {
        "description": "Participate in science competitions and build STEM projects",
